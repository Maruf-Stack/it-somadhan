...
const Footer = () => <div className="footer-container">
    <footer className="px-10 pt-20 pb-2 mt-24 text-base-content footer">
...
<p className="mt-8 footer-title copyright text-center">Copyright © 2023 - All right reserved</p>
