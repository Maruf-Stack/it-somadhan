...
const Hosting = () => {
    ...
    return (
        <div className='my-20' id='hosting'>
            ...
            <Fade>
            <div className='grid grid-cols-1 gap-4 mx-2 mt-10 lg:gap-0 lg:mt-14 all-hosting lg:grid-cols-3 lg:mx-0'>
                <div className='flex items-center gap-3 lg:mx-auto mx-0 single-hosting'>
