    ...
    <div id="services">
      ...
      <Fade>
        <div className="grid lg:grid-cols-5 justify-items-center grid-cols-3 gap-5 lg:gap-5">
          <Card
            sx={{ maxWidth: 240, backgroundColor: "black" }}
          ...
          <Card
            sx={{ maxWidth: 240, backgroundColor: "black" }}
            className="service-card clservice"
            style={{
              display:
                showSections || window.innerWidth >= 767 ? "block" : "none",
            }}
          >
            <CardActionArea>
              <div className="geeks">
      ...
      <div className="normal-case text-center mt-8">
        {!showSections ? (
          <button className="viewallbtn" onClick={() => toggleShowSections()}>
            View all{" "}
            <BsFillArrowRightCircleFill className="inline"></BsFillArrowRightCircleFill>
          </button>
        ) : (
          <button className="viewallbtn" onClick={() => toggleShowSections()}>
            View less{" "}
